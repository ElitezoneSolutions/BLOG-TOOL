...
import { Save, X, Hash, Tag, Image as ImageIcon, Link as LinkIcon } from 'lucide-react'

export default function NewPost() {
  return (
    <div className="space-y-6 animate-fade-in pb-10">
      <div className="flex justify-between items-center mb-2">
        <h1 className="text-xl font-bold text-slate-900">New Article</h1>
        <Link 
          href="/admin"
      ...
      <form action={createPost} className="grid lg:grid-cols-4 gap-6">
